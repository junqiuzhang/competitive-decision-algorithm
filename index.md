...
容易想到，在选址问题中，设施对顾客的服务成本和设施的建设成本越低，竞争力越大；所以，我们规定竞争力函数与设施的对顾客的服务费用和设施的建设费用成反比。进一步地，如果服务该顾客不需要重新建立设施，即设施未确定建设，则竞争力函数值仅与设施的对顾客的服务费用成反比；否则，设施已经确定建设，竞争力函数值就与设施的对顾客的服务费用与设施的建设费用之和成反比，而如果当前设施的容量已满，则其竞争力为零，故竞争力函数的表达式为：
...
而在选址问题中，总费用函数就是目标函数；决策函数就是分配顾客给竞争力函数值大的设施，并且需要满足重新分配顾客给设施后可以使总费用函数值小于目前已知的最优竞争决策状态下的总费用函数值；资源交换规则就是交换任意两个设施服务的全部顾客，使竞争进入一个非稳定的竞争决策状态。
...
如果该设施容量已满，则判断相对于该设施为劣势的设施是否需要打开参与竞争。
具体的判断规则为：如果相对劣势设施的所有相对优势设施容量都已满，则打开相对劣势设施参与竞争。
